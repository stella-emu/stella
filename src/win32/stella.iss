...
OutputBaseFilename=stella-2.8-win32
Compression=lzma
...
[Files]
Source: "..\..\stella-2.8\Stella.exe"; DestDir: "{app}"; Flags: ignoreversion
;Source: "..\..\stella-2.8\zlib1.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\stella-2.8\SDL.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\stella-2.8\docs\*"; DestDir: "{app}\docs"; Flags: ignoreversion recursesubdirs createallsubdirs
