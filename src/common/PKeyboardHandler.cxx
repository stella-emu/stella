...
PhysicalKeyboardHandler::DefaultCommonMapping = []() noexcept {
  static constexpr EventMapping data[] = {
    ...
    { Event::CurvatureDecrease,        StellaKey::_7, StellaMod::SHIFT | MOD3 },
    { Event::CurvatureIncrease,        StellaKey::_7, MOD3 },
    { Event::VCurvatureDecrease,       StellaKey::_8, StellaMod::SHIFT | MOD3 },
    { Event::VCurvatureIncrease,       StellaKey::_8, MOD3 },
