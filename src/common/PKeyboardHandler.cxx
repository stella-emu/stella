...
PhysicalKeyboardHandler::KeyPortariMapping = [] noexcept {
  static constexpr EventMapping data[] = {
    ...
    {Event::KeyPortariExclam,        KBDK_KP_EXCLAM},
    {Event::KeyPortariQuote,         KBDK_APOSTROPHE, KBDM_SHIFT},
    {Event::KeyPortariHash,          KBDK_KP_3, KBDM_SHIFT},
    {Event::KeyPortariDollar,        KBDK_4, KBDM_SHIFT},
    {Event::KeyPortariPercent,       KBDK_PERIOD},
    {Event::KeyPortariAmpersand,     KBDK_KP_AMPERSAND},
    {Event::KeyPortariGrave,         KBDK_GRAVE},
    {Event::KeyPortariLeftParen,     KBDK_KP_LEFTPAREN},
    {Event::KeyPortariRightParen,    KBDK_KP_RIGHTPAREN},
    {Event::KeyPortariMultiply,      KBDK_8, KBDM_SHIFT},
    {Event::KeyPortariPlus,          KBDK_KP_PLUS},
    ...
    {Event::KeyPortariLessThan,      KBDK_KP_LESS},
    {Event::KeyPortariEquals,        KBDK_EQUALS},
    {Event::KeyPortariGreaterThan,   KBDK_KP_GREATER},
    {Event::KeyPortariQuestion,      KBDK_SLASH, KBDM_SHIFT},
    {Event::KeyPortariAt,            KBDK_KP_AT},
    ...
    {Event::KeyPortariCaret,         KBDK_KP_6, KBDM_SHIFT},
    ...
    {Event::KeyPortariLeftBrace,     KBDK_KP_LEFTBRACE},
    {Event::KeyPortariVerticalBar,   KBDK_KP_VERTICALBAR},
    {Event::KeyPortariRightBrace,    KBDK_KP_RIGHTBRACE},
