...
#ifndef CARTRIDGE_BFSC_HXX
#define CARTRIDGE_BFSC_HXX
...
class CartridgeBFSC : public CartridgeBF
{
  ...
  public:
    ...
    */
    CartridgeBFSC(ByteSpan image, string_view md5,
    ...
    */
    ...
    {
      return new CartridgeBFSCWidget(boss, lfont, nfont, *this);
    }
  #endif
