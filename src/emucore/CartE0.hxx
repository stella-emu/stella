...
#ifndef CARTRIDGE_E0_HXX
#define CARTRIDGE_E0_HXX
...
class CartridgeE0 : public CartridgeEnhanced
{
  ...
  public:
    ...
    */
    CartridgeE0(ByteSpan image, string_view md5,
  ...
  public:
    ...
    */
    ...
    {
      return new CartridgeE0Widget(boss, lfont, nfont, *this);
    }
  #endif
