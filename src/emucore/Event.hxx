  ...
  public:
    ...
    */
    enum Type: uInt16
    {
      ...
      KeyPortariLeftParen, KeyPortariRightParen, KeyPortariMultiply,
      KeyPortari0, KeyPortari1, KeyPortari2, KeyPortari3, KeyPortari4,
      KeyPortari5, KeyPortari6, KeyPortari7, KeyPortari8, KeyPortari9,
      KeyPortariA, KeyPortariB, KeyPortariC, KeyPortariD, KeyPortariE,
      KeyPortariF, KeyPortariG, KeyPortariH, KeyPortariI, KeyPortariJ,
      KeyPortariK, KeyPortariL, KeyPortariM, KeyPortariN, KeyPortariO,
      KeyPortariP, KeyPortariQ, KeyPortariR, KeyPortariS, KeyPortariT,
      KeyPortariU, KeyPortariV, KeyPortariW, KeyPortariX, KeyPortariY,
      KeyPortariZ,
      KeyPortariLowercaseA, KeyPortariLowercaseB, KeyPortariLowercaseC,
      KeyPortariLowercaseD, KeyPortariLowercaseE, KeyPortariLowercaseF,
      KeyPortariLowercaseG, KeyPortariLowercaseH, KeyPortariLowercaseI,
      KeyPortariLowercaseJ, KeyPortariLowercaseK, KeyPortariLowercaseL,
      KeyPortariLowercaseM, KeyPortariLowercaseN, KeyPortariLowercaseO,
      KeyPortariLowercaseP, KeyPortariLowercaseQ, KeyPortariLowercaseR,
